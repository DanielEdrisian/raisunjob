...
class MyadsWidget extends StatefulWidget {
  const MyadsWidget({
    Key? key,
    required this.recuiterDocument,
  }) : super(key: key);

  final RecruitersRecord? recuiterDocument;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Builder(
                                          builder: (context) {
                                            final jobsPosted = widget
                                                .recuiterDocument!.jobsPosted
                                                .map((e) => e)
                                                .toList();
                                            return ListView.builder(
                                              ...
                                              itemBuilder:
                                                  (context, jobsPostedIndex) {
                                                final jobsPostedItem =
                                                    jobsPosted[jobsPostedIndex];
                                                return Padding(
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        '${jobsPostedItem.jobTotalVacancy.toString()} Vacancy',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              fontFamily: 'Sora',
